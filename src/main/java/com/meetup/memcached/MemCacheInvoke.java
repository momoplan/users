...
// 设置服务器权重
    ...
    public static void main(String[] args) {
    	...
    	mcc.add("foo", "a test String可以了",60);
        // String bar = getMemcachedByKey("foo","127.0.0.1:11211",0).toString();
         String bar1 = mcc.get("foo").toString();
         System.out.println(">>> " + bar1);
     	mcc.add("foo", "is a test String可以了:=="+System.currentTimeMillis(),60);
     	bar1 = mcc.get("foo").toString();
     	System.out.println(">>> " + bar1);
    	
    	
        mcc.set("foo1", "This is a test String可以了",60);
       // String bar = getMemcachedByKey("foo","127.0.0.1:11211",0).toString();
        String bar = mcc.get("foo1").toString();
        System.out.println(">>> " + bar);
    	mcc.set("foo", "This111111 is a test String可以了:=="+System.currentTimeMillis(),60);
    	bar = mcc.get("foo").toString();
    	System.out.println(">>> " + bar);
    }
