...
public class MessageUtil {
	...
	public static final String TIAW_changeUserinfo_mobile_NULL = "您填写手机号不能为空！";
	 ...
	 * 话费购买投注返回信息
	 */
	public static final String CHARGESBET_PhoneMessage ="对不起，本功能暂仅支持中国移动号码！请您用中国移动号码注册后再使用本功能！";
	public static final String CHARGESBET_Code_6 = "200006";
	public static final String CHARGESBET_Code_60 = "200060";
	public static final String CHARGESBET_Code_30 = "200030";
	public static final String CHARGESBET_Code_Area = "200100";
	public static final String CHARGESBET_Message_60 = "您订阅话费购彩功能正在处理中，请耐心等待！";
	public static final String CHARGESBET_Message_61 = "您已经订阅了话费购彩功能！";
	public static final String CHARGESBET_Message_30 = "本月您通过话费购彩已达到最高上限30元，请下月再使用或使用普通购买方式进行购彩！";
	public static final String CHARGESBETAREA_Message_Area = "话费购彩只支持4种购彩金额：2元、10元、20元、30元。请您重新选择购彩金额或使用普通购买方式进行买彩！";
	 ...
	 * 发送邮件的信息
	 */
	public static String EMAILSESSAGE=
		"亲爱的"
		+"{nickname}"
		+ ":您好!"
		+ "<br/>"
		+ "请您点击下面链接找回3G彩票网登录密码，如果不做任何操作，您将无法正常使用3G彩票网相关服务。"
		+ "<br/>"
		...
		+ "<br/>"
		+ "此为系统邮件，请勿回复!"
		+ "请保管好您的邮箱，避免3G彩票网账户被他人盗用。"
		+ "如有任何疑问，可查看3G彩票网相关规则，3G彩票网网站访问http://www.3gcaipiao.com"
		+ "<br/>"
		+ "2003-2011 联动优势科技有限公司版权所有 京ICP证030914号"
		+ "<br/>"
		+ "电信与信息服务业务经营许可证 京2-2-1-2004109";
	/**
	 * 如意彩发送邮件的信息
	 */
	...
	+"　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　"
	+"如意彩"+"<br/>"+"客服电话:400-665-1000（工作时间周一至周五9:00-18:00（节假日除外））"+"<br/>"+"(这是一封自动产生的email，请勿回复。)</body></html>";
	...
	+"　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　如意彩"
	+"<br/>"+"客服电话:400-665-1000（工作时间周一至周五9:00-18:00（节假日除外））"+"<br/>"+"(这是一封自动产生的email，请勿回复。)</body></html>";
}
