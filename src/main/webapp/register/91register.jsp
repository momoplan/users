...
<base href="<%=basePath%>">
<meta http-equiv="keywords" content="91如意彩，用户注册，购彩服务"/>
<meta http-equiv="description" content="现在免费注册成为91如意彩用户，便能立刻享受便捷的购彩服务"/>
<title>用户注册</title>
		...
		<input name="sign" type="hidden"  value="91ruyicai"/>
			<table border="0" cellspacing="0" cellpadding="0" class="ZhuCe_table table_space">
				...
				<tr>
					...
					<input type="button" class="ZhuCe_btn light" id="phoneregister_submit" onclick="register_91()" value="立即注册" /></th>
				</tr></tfoot>
			</table>
		</form>
	</div>
