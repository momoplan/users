...
<div class="ZhuCe_remind"><em>为了您的账户安全，请如实填写以下资料</em>：（该资料作为领奖和提款的重要凭证，91如意彩绝对不会泄露你的个人信息）</div>
...
<table border="0" cellspacing="0" cellpadding="0" class="ZhuCe_table second_space">
	...
	<tr>
		...
		<td width=""><span id="nicknameImage"></span><span id="nicknameTip">4-16个字符，支持数字、英文、汉字组合，设置成功后不可更改</span></td>
	</tr>
	<tr>
		<th>真实姓名：</th>
	...
	<tr>
		<th>请输入验证码:</th>
		<th><input name="" type="text" class="ZhuCe_input" id="verifyCode" onblur="checkverifyCode();"></th>
		<td><span id="a2" class="phone_sendMessageBtn"  onclick="send();">获取验证码</span>
		<span id="a1" class="phone_sendMessageBtnHide" onclick="resend();"><!-- 在<span id="count">60</span>秒后 -->点此重发</span> 
		<span id="verifyCodeImage"></span> <span id="verifyCodeTip">请输入您手机中的4位数字验证码。</span></td>
	</tr>
	<tr>
		<th>电子邮箱：</th>
	...
	<tr>
		<th>&#160;</th>
		<th colspan="3" class="special_td"><input name="" type="button" class="ZhuCe_btn" value="提交信息" id="registerbutton" onclick="verifyuserinfo_91()"/><a href="javascript:reHtmljsp(1,'',true,'registerbody',false);" title="以后再说">以后再说</a></th>
	</tr>
</table>
